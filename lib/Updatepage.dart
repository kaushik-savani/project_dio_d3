...
class _UpdatePageState extends State<UpdatePage> {
  ...
  void initState() {
    ...
    super.initState();
    print(widget.index);
    tmno.text = widget.m!.addressList![widget.index].mobile!;
    tname.text = widget.m!.addressList![widget.index].name!;
  }
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            String address_id =
                                widget.m!.addressList![widget.index].addressId!;
                            String gps_address = address1;
                            String address_type = adtype;
                            String mobile = tmno.text;
                            String name = tname.text;
                            var response = await Dio().get(
                                'http://workfordemo.in/bunch3/update_address.php?address_id=$address_id&gps_address=$gps_address%20road,%20surat&latitude=21.84444&longitude=72.54445&address_type=$address_type&mobile=$mobile&name=$name');
                            print(response.data);
